    ...
    <section class="content">
     <div class="box box-default">
      ...
      <div class="box-body">
       ...
       <div class="col-xs-12">
        <h2>DESEJA REALMENTE REATIVAR CLUBE ?</h2>
       </div>
       <form name="ReativaClube" id="name" method="post" action="" enctype="multipart/form-data">
        ...
        <div class="col-xs-12"><br />
         <input name="ReativaClube" type="submit" class="btn btn-primary btn-lg btn-block" value="REATIVAR CLUBE"  />
        </div>
       </form>
       <?php 
        if(@$_POST["ReativaClube"])
        {
         ...
         if ($CryRDI === $SenhaUsuarioLogado) 
         {
          $RotaryPadrinho = $_POST['RCPadrinho'];
           $executa = $PDO->query("UPDATE icbr_clube SET icbr_Status='A', icbr_RotaryPadrinho='$RotaryPadrinho' WHERE icbr_id='$codClube' ");
           if($executa)
           {
           ...
           {
            echo '<script type="text/javascript">alert("NÃO FOI POSSÍVEL REATIVAR O CLUBE. TIRE UM PRINT DESTA MENSAGEM E ENTRE EM CONTATO COM O ADMINISTRADOR");</script>';
            echo '<script type="text/javascript">window.close();</script>';
           }
         }
         else 
