...
$mensagem = '
		...
		<head>
		 ...
		 <style>body{margin: 0;padding: 0;}@media only screen and (max-width: 340px){table, img[class="partial-image"]{ width:100% !important; min-width: 200px !important; }}</style><body topmargin=0 leftmargin=0><!--?xml encoding="utf-8" ?-->
		              ...
		              <tbody>
		               ...
		               <td align="center" style="border-collapse: collapse; line-height: 0px; padding: 0; mso-line-height-rule: exactly;">
		                <a target="_blank" style="display: block; text-decoration: none; box-sizing: border-box; font-family: arial; width: 100%;">
		                 <img class="partial-image" src="img/interactbranco.png" width="600" style="box-sizing: border-box; display: block; max-width: 600px; min-width: 160px;">
		                </a>
		               </td>
		               </tr>
		              </tbody>
		              ...
		              <tbody>
		               <tr>
		                <td style="border-collapse: collapse;">
		                 <h2 style="font-weight: normal; margin: 0px; padding: 0px; color: rgb(251,73,89); word-wrap: break-word;">
		                   <span style="font-size: inherit; text-align: center; width: 100%; color: rgb(0,165,208);">Voc&ecirc; tem um novo projeto, Hora de Revisar!</span>
		                 </h2>
		                </td>
		               </tr>
		              </tbody>
		               ...
		               <tr>
		                <td style="border-collapse: collapse;">
		                 <div style="font-family: Arial; font-size: 15px; font-weight: normal; line-height: 170%; text-align: left; color: #666; word-wrap: break-word;">
		                  <span>Foi cadastrado um novo projeto para o seu clube, e você recebeu uma nova chave para edita-lo.</span><br />
		                   <h3 style="font-weight: normal; margin: 0px; padding: 0px; color: rgb(251,73,89); word-wrap: break-word;">
		                    <span style="font-size: inherit; text-align: center; width: 100%; color: rgb(0,165,208);">
		                     Nome do Projeto: <span style="color: rgb(251,73,89);">NOME DO PROJETO PARA REVISAR</span><br />
		                     Data de Cadastro: <span style="color: rgb(251,73,89);">10/01/2017</span>
		                     Avenida: <span style="color: rgb(251,73,89);">COMUNIDADES</span><br />
		                    </span>
		                 <h2 style="font-weight: normal; margin: 0px; padding: 0px; color: rgb(251,73,89); word-wrap: break-word;">
		                   <span style="font-size: inherit; text-align: center; width: 100%; color: rgb(0,165,208);">Chave de Acesso:</span>
		                   <span style="font-size: inherit; text-align: center; width: 100%; color: rgb(251,73,89);">JJKO23JKSAS</span>
		                 </h2>
		                 </h3>		                 
		                 </div>
		                </td>
				   ...
				   <tr>
				    <td style="border-collapse: collapse; font-family: Arial; padding: 10px 15px;">
				     <div style="font-family: Arial; text-align: center;">
				      <table style="border-collapse: collapse; border-spacing: 0; background-color: rgb(251,73,89); border-radius: 10px; color: rgb(255,255,255); display: inline-block; font-family: Arial; font-size: 15px; font-weight: bold; text-align: center;">
				       <tbody style="display: inline-block;">
				        <tr style="display: inline-block;">
				         <td align="center" style="border-collapse: collapse; display: inline-block; padding: 15px 20px;">
				          <a target="_blank" href="#LINKEDITARPROJETO" style="display: inline-block; text-decoration: none; box-sizing: border-box; font-family: arial; color: #fff; font-size: 15px; font-weight: bold; margin: 0px; padding: 0px; text-align: center; word-wrap: break-word; width: 100%;">CLIQUE AQUI PARA EDITAR SEU PROJETO
				          </a>
				         </td>
				        </tr>
				       </tbody>
